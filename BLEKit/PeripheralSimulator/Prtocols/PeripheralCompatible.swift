...
extension CBPeripheral: PeripheralCompatible {
    ...
    public func mockReadValue(for action: BLEKit.PeripheralAction.Action) { }

    public func mockWriteValue(_ data: Data, for action: BLEKit.PeripheralAction.Action, type: CBCharacteristicWriteType) { }

    public func mockSetNotifyValue(_ enabled: Bool, for action: BLEKit.PeripheralAction.Action) { }
